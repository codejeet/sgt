...
- 2026-03-24T14:20:00+01:00 — 2026-03-24 correction: the March 12-13 shared-context notes describing shipped Mayor prompt-budget/structured-compaction behavior were stale. On current `master`, `_mayor_build_briefing` only assembles the live sections listed in README, and issue #235 removes the bogus budget/compaction proof scripts plus the matching doc claims.
