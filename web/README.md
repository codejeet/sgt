...
- **Recent alert rail** — New blocker openings and resolutions surface as explicit alert cards instead of blending into the blocker list
- **Optional ElevenLabs voice** — Env-gated blocker voice announcements with browser mute control and backend dedupe/rate limiting
...
- **Voice announcements are unavailable**
  ...
  - The browser mute toggle only affects local playback. Backend rate limiting and event gating still apply globally for eligible announcements.
